...
if (isset($_GET["cursus"]) && isset($_GET["elementFormation"]) && isset($_GET["sem"])) {
    //faire le check au niveau des input

    $id_cursus = $_GET["cursus"];
    $id_element_formation = $_GET["elementFormation"];
    $sem_label = $_GET["sem"];


    $modelElementFormationEffectue = ModelElementFormationEffectue::getElementFormationEffectue($id_cursus, $id_element_formation, $sem_label);
